    ...
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 shrink-0 z-30">
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        <button
          ...
          title={bcvInfo.cycleRuleDescription || "Sincronización en tiempo real con tasa oficial BCV"}
        ...
        >
          ...
          {bcvInfo.isWeekendRate && (
            <span className="hidden sm:inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-bold bg-amber-100 text-amber-800 border border-amber-200" title="Tasa del Lunes válida para Viernes, Sábado y Domingo">
              Vie-Dom (Tasa Lun)
            </span>
          )}
          <RefreshCw
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            id="role-logout-btn"
            onClick={logoutSession}
            className="px-2 py-1 rounded-lg bg-white border border-slate-200 hover:border-rose-300 hover:bg-rose-50 text-slate-600 hover:text-rose-700 text-xs font-semibold flex items-center gap-1 transition cursor-pointer shadow-2xs"
            title="Cerrar Sesión / Salir a Pantalla de Acceso"
          >
